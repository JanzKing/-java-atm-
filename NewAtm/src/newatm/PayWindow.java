...
public class PayWindow extends JFrame implements ActionListener
{
		...
		JPanel jp1,jp2=null;
		static JTextField jtf1=null;     //文本
		JLabel jlb1=null;
		JFrame fr;
		//Image image;
		ImageIcon icon;
	    ...
	    //构造函数
		public PayWindow()    //不能申明为void!!!!!否则弹不出新界面
		{
			//设置标题  
	        super("信本银行");  //setTile("");
	        //设置大小  
		...
		public JTextField getJtf1(){
			//System.out.println(jtf1.getText().trim());
			return jtf1;
		}
		@Override
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==jb1){
				//向数据库发送操作
	    		PayWarning a=new PayWarning();
	    		a.setVisible(true);
			}
			else if(e.getSource()==jb2){
	    		dispose();
	    		AtmWindow b=new AtmWindow();
	    		b.setVisible(true);
			}
		}
}
